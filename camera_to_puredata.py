...
class CameraToPureData:
    def __init__(self, camera_index=0, osc_ip="127.0.0.1", osc_port=5580):
        ...
        # Parámetros de layout para interfaz
        self.padding = 10
        ...
        self.show_camera_runtime = True
        self.show_grid_runtime = False
        
        # Variables de layout calculadas
        self.button_bar_y = 0
        self.camera_y_offset = 0
        self.grid_y_offset = 0
        self.width = 0
        self.height = 0
        self.close_button_bounds = (0, 0, 0, 0)
        self.toggle_camera_button_bounds = (0, 0, 0, 0)
        self.toggle_grid_button_bounds = (0, 0, 0, 0)
    ...
    def _recalculate_layout(self) -> None:
        """
        Recalcula el layout de la interfaz basado en los elementos visibles
        """
